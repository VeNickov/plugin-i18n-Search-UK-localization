<?php
  ...
  if (!array_key_exists('showUl', $params)) $params['showUl'] = true;
  if (!array_key_exists('showScript', $params)) $params['showScript'] = true;
  ...
  <form method="post" id="searchForm" action="<?php echo $link; ?>" style="clear:both">
    <table id="editsearch" class="edittable highlight">
      <tbody>
		...
		<tr><td><?php i18n('i18n_search/SHOW_SCRIPT'); ?></td><td><input type="checkbox" name="showScript" value="on" <?php echo @$params['showScript'] ? 'checked="checked"' : ''; ?>/></td><td>(showScript)</td></tr>
		...
		<tr><td><?php i18n('i18n_search/SHOW_UL'); ?></td><td><input type="checkbox" name="showUl" value="on" <?php echo @$params['showUl'] ? 'checked="checked"' : ''; ?>/></td><td>(showUl)</td></tr>
  ...
  <p><?php i18n('i18n_search/CUSTOMIZE_3'); ?></p>
    <table id="editsearch" class="edittable highlight">
      ...
      <tbody>
		...
		<tr><td>showScript</td><td><?php i18n('i18n_search/SHOW_SCRIPT'); ?></td></tr>
		...
		<tr><td>showUl</td><td><?php i18n('i18n_search/SHOW_UL'); ?></td></tr>
